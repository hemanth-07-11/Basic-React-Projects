...
const App = () => {
  const [Rvalue, setRvalue] = useState(70)
  const [Gvalue, setGvalue] = useState(205)
  const [Bvalue, setBvalue] = useState(170)

  const hexColor = rgbToHex(Rvalue, Gvalue, Bvalue)

  return <div className='wrap'>
    <div className='content'>
      <h1 style={{marginBottom:'20px'}}>Slide and Pick Colors</h1>
